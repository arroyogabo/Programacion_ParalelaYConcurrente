...
int main(int argc, char* argv[]) {
	...
	vector<float> bin_maxes;  // vector de máximos por bin
	vector<int> bin_counts;   // vector para contar valores por bin
	int data_count;			  // cantidad de datos
	vector<float> data;		  // vector de datos generado aleatoriamente.
	double wtime;
...
void usage(string prog_name /* in */) {
	cerr << "usage: " << prog_name << "<thread_count> <bin_count> <min_meas> <max_meas> <data_count>\n" << endl;
	exit(0);
}  /* usage */
